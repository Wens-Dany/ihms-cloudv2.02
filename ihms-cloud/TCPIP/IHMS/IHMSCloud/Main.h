...
#define MAXSENSORDATASIZE         80000//56000       //  for collecting MMA8451 Q acceleration sensor XYZ sample output (2 bytes for each X, Y , Z data output; 1 byte for Data Status Register
