...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/httpsock.o: httpsock.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/httpsock.o.d 
	@${RM} ${OBJECTDIR}/httpsock.o 
	@${FIXDEPS} "${OBJECTDIR}/httpsock.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMRF24WG -I".." -I"../../Microchip/Include" -I"../../Microchip/Include/TCPIP Stack" -I"../../../../Microchip/Include" -I"../../../Microchip/Include/TCPIP Stack" -I"../../../Microchip/Include" -Wall -MMD -MF "${OBJECTDIR}/httpsock.o.d" -o ${OBJECTDIR}/httpsock.o httpsock.c   
	
${OBJECTDIR}/httpclient.o: httpclient.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/httpclient.o.d 
	@${RM} ${OBJECTDIR}/httpclient.o 
	@${FIXDEPS} "${OBJECTDIR}/httpclient.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMRF24WG -I".." -I"../../Microchip/Include" -I"../../Microchip/Include/TCPIP Stack" -I"../../../../Microchip/Include" -I"../../../Microchip/Include/TCPIP Stack" -I"../../../Microchip/Include" -Wall -MMD -MF "${OBJECTDIR}/httpclient.o.d" -o ${OBJECTDIR}/httpclient.o httpclient.c   
...
${OBJECTDIR}/motionsensor.o: motionsensor.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/motionsensor.o.d 
	@${RM} ${OBJECTDIR}/motionsensor.o 
	@${FIXDEPS} "${OBJECTDIR}/motionsensor.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -DMRF24WG -I".." -I"../../Microchip/Include" -I"../../Microchip/Include/TCPIP Stack" -I"../../../../Microchip/Include" -I"../../../Microchip/Include/TCPIP Stack" -I"../../../Microchip/Include" -Wall -MMD -MF "${OBJECTDIR}/motionsensor.o.d" -o ${OBJECTDIR}/motionsensor.o motionsensor.c   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-L"..",-Map="${DISTDIR}/WiFi_Card_Demo.X.${IMAGE_TYPE}.map",--report-mem "-mperipheral-libs"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-L"..",-Map="${DISTDIR}/WiFi_Card_Demo.X.${IMAGE_TYPE}.map",--report-mem "-mperipheral-libs"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/IHMSCloud.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
