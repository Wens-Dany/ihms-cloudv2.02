...
#define MY_DEFAULT_SSID_NAME				"BCCAP"
...
#define MY_DEFAULT_WIFI_SECURITY_MODE       WF_SECURITY_WPA_AUTO_WITH_PASS_PHRASE  //WF_SECURITY_OPEN
...
#define MY_DEFAULT_PSK_PHRASE                "27881618"
